...
<div id="fs_connect"
	...
	<div class="fs-visual">
		<img src='<?php echo BREW_PLUGIN_IMAGES_URL; ?>connect_freemius.png' style='width:100%; height: 100%;'>
	</div>
...
//			),
	...
	<?php endif ?>
	<div class="fs-terms">
		<a href="https://inboundbrew.com/plugin/plugin-privacy-policy/" target="_blank"
		   tabindex="1"><?php _efs( 'privacy-policy', $slug ) ?></a>
		&nbsp;&nbsp;-&nbsp;&nbsp;
		<a href="https://inboundbrew.com/plugin/terms-of-service/" target="_blank" tabindex="1"><?php _efs( 'tos', $slug ) ?></a>
	</div>
</div>
