                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="ib_data-tables stripe">
                    ...
                    <?php foreach($leads as $lead):?>
                        <tr id="ib_lead-row-<?php echo $lead->lead_id; ?>">
                            ...
                            <td class="ib-main">
                                <?php echo isset($lead->lead_name)?$lead->lead_name:'NA';?>
                                <br />
                            ...
                            <td>
	                            ...
	                            <a href="<?php echo $trash_url; ?>" class="red ib-confirm" data-confirm="Are you sure you want to delete this lead?">[delete]</a>&nbsp;&nbsp;
                                <a href="admin.php?page=ib-leads-admin&section=lead&id=<?php echo $lead->lead_id; ?>" data-role="edit-lead" class="ib-link">[view]</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
